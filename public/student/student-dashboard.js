            ...
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ${latest.subjects?.map(sub => `
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${sub.subject}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${sub.total_marks}/${sub.max_marks}</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full ${
                                    sub.grade === 'A+' || sub.grade === 'A' ? 'bg-green-100 text-green-800' :
